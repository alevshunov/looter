    ...
    public async execute(connection: MyConnection, request: Request): Promise<any> {
        ...
        const players = await connection.query(`
            select
                ...
                wp_rate.rate_woe_attribute_id = a.id isMain,
                wp_rate.rate_aux_woe_attribute_id = a.id isAux,
            ...
            from
                ...
                left join woe_attribute wa1 on wa1.id = wp_rate.rate_woe_attribute_id
                left join woe_attribute wa2 on wa2.id = wp_rate.rate_aux_woe_attribute_id
                inner join woe_attribute a on a.id = pv.woe_attribute_id
